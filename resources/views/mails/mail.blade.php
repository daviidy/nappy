...
<head>
    ...
    <title>Votre achat a été validé</title>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" class="brdBottomPadd-two" id="templateContainer" width="100%">
                                <tr>
                                    <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                                        ...
                                        <h1><strong>Votre achat de ticket pour<br>
                    Minaci 2018 a été validé!</strong></h1>

                                        <h3>Merci pour votre achat. Conservez bien ce ticket, car
                                        vous devrez le présenter aux préposés à l'accueil
                                      lors de l'événément</h3>
                                    </td>
                                </tr>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                    <h3><strong>Numéro du ticket : {{$ticket->id}}</strong></h3>
                                                    <h4></h4>
                                                </td>
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                    <h3><strong>Email Associé : {{$ticket->email}}</strong></h3>
                                                    <h4></h4>
                                                </td>
